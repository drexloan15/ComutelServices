...
export const queryKeys = {
  ...
  ticketWorkspace: (ticketId: string) => ["tickets", ticketId, "workspace"] as const,
  ...
  ticketMacros: ["tickets", "macros"] as const,
  ...
  cmdbServices: ["cmdb", "services"] as const,
  cmdbAssets: ["cmdb", "assets"] as const,
  slaPredictions: (windowHours: number) => ["sla", "predictions", windowHours] as const,
};
